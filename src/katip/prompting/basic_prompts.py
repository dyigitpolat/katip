...
"""Refer to other work and experiments as much as possible. To cite, always use the syntax ((citation_needed: <put meaningful keywords (WITHOUT author names) about relevant studies>)). to refer to experiments and results, always use the syntax ((result_needed: <put a short description of the required experiment here>)). Refer to other work and experiments as much as possible using our special ((citation_needed: ...)) or ((result_needed: ...)) syntax."""